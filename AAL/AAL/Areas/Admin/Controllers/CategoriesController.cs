...
namespace AAL.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(AALContext context)
        {
            _context = context;
        }
        ...
        {
            var aALContext = _context.Categories.Include(c => c.CatParent);
        ...
        public async Task<IActionResult> Create([Bind("CatId,CatName,CatParentId")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatId,CatName,CatParentId")] Category category)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AALContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
